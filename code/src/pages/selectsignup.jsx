    ...
    return ( 
        ...
        <div className="selection">
            <div className="section1" onClick={() => goToPage('organizationsignup')} style={{cursor: 'pointer'}}>
                ...
                <p style={{fontFamily: "Satoshi", fontSize:"20px"}}>fund raising and project management profiles for fund raising</p>
            </div>

            <div className="section2">
                <h3 style={{fontFamily: "Satoshi", fontSize:"30px"}}>Create account as a User</h3>
                <p style={{fontFamily: "Satoshi", fontSize:"20px"}}>items buying, selling and donating to rank up</p>
            </div>
        </div>
        </>
     );
